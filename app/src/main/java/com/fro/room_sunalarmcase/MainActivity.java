...
public class MainActivity extends Activity {
	...
	private EditText sunIp_et; // Sun-Light IP Address
	private EditText sunPort_et; // Sun-Light Port Number
...
//					String CURTAIN_PORT = curtainPort_et.getText().toString().trim();
					...
					if (checkIpPort(SUN_IP, SUN_PORT)){
						Log.d("tag1", "onCheckedChanged: ");
					}
